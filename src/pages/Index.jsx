...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-100 to-teal-100">
      <Header />
      <HeroSection />
      <AboutSection />
      <ProjectsSection />
...
const Header = () => (
  <header className="bg-white bg-opacity-80 shadow-sm">
    <div className="container mx-auto px-4 py-6 flex justify-between items-center">
      <h1 className="text-2xl font-bold text-amber-600">Marcelino Landen</h1>
      <nav>
        <ul className="flex space-x-4">
          <li><a href="#about" className="text-teal-600 hover:text-amber-500 transition-colors">About</a></li>
          <li><a href="#projects" className="text-teal-600 hover:text-amber-500 transition-colors">Projects</a></li>
          <li><a href="#contact" className="text-teal-600 hover:text-amber-500 transition-colors">Contact</a></li>
        </ul>
      </nav>
    </div>
  </header>
...
const HeroSection = () => (
  <section className="bg-gradient-to-r from-amber-500 to-teal-500 text-white py-20">
    <div className="container mx-auto px-4 text-center">
      ...
      <Button variant="secondary" size="lg" className="bg-white text-amber-500 hover:bg-amber-100">View My Work</Button>
    </div>
  </section>
);
  ...
  <section id="about" className="py-20">
    <div className="container mx-auto px-4">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        <img src="/marcelino-landen.jpg" alt="Marcelino Landen" className="w-64 h-64 rounded-full mb-8 md:mb-0 md:mr-8 border-4 border-amber-500 shadow-lg object-cover" />
...
const ProjectsSection = () => (
  <section id="projects" className="bg-gradient-to-br from-amber-200 to-teal-200 py-20">
    <div className="container mx-auto px-4">
...
const ProjectCard = ({ title, description, children }) => (
  <Card className="bg-white bg-opacity-80 border-2 border-amber-300 shadow-lg">
...
const ContactSection = () => (
  <section id="contact" className="py-20 bg-gradient-to-br from-teal-100 to-amber-100">
    <div className="container mx-auto px-4 text-center">
      <h2 className="text-3xl font-bold mb-8 text-teal-700">Get in Touch</h2>
      <p className="text-xl mb-8 text-amber-700">I'm always open to new opportunities and collaborations.</p>
      <div className="flex justify-center space-x-4">
        <Button variant="outline" size="icon" className="bg-white border-teal-500 text-teal-500 hover:bg-teal-100">
          <GithubIcon className="h-5 w-5" />
        </Button>
        <Button variant="outline" size="icon" className="bg-white border-amber-500 text-amber-500 hover:bg-amber-100">
...
const Footer = () => (
  <footer className="bg-gradient-to-r from-amber-600 to-teal-600 text-white py-8">
    <div className="container mx-auto px-4 text-center">
